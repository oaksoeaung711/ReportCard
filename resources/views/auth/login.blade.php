...
<body>
    <div class="h-screen flex items-center justify-center">
        <div class="bg-gray-50 text-gray-500 rounded-xl shadow-2xl overflow-hidden flex max-w-5xl">
            <div class="w-1/2 hidden md:block pt-12">
                <img src="{{ asset('images/factory.svg') }}" class="" alt="register" />
            </div>

            <div class="w-full md:w-1/2 px-5 py-5">
                <div class="text-center mb-5">
                    <h1 class="font-bold text-xl text-gray-700 tracking-wide">WELCOME</h1>
                </div>
                <x-session-message/>
                <div>
                    <form action="{{ route('user.login') }}" method="POST">
                        ...
                        <div class="mt-5">
                            <button type="submit" class="w-full bg-gray-500 text-white text-xs font-semibold py-2 rounded-sm uppercase hover:bg-gray-600">lOGIN</button>
                        </div>
                    </form>
                </div>
                <div class="text-center mt-3">
                    <p class="text-xs">Don't have an account? Register <a href="{{ route('register') }}" class="text-gray-800">Here !</a></p>
                </div>
            </div>
        </div>
    </div>
